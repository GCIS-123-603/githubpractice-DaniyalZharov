...
# Actual Working Code (Mairo) from the Internet, particularly stackoverflow.com for demstration of how the format/structure of the code should be
# The result is executed dirctly without turtle drawing it & without a grid
